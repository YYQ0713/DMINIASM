...
//		fprintf(stderr, "    -B          only one direction of an arc is present in input PAF\n"); // deprecated; for backward compatibility
	...
	gettimeofday(&tv1, NULL);//time of step1
	...
	fprintf(stderr, "Step1 time = %f seconds\n", (double) (tv2.tv_usec - tv1.tv_usec) / 1000000 + (double) (tv2.tv_sec - tv1.tv_sec));
	
	if (!no_first) {
		gettimeofday(&tv1, NULL);//time of step2
		...
		gettimeofday(&tv2, NULL);
		fprintf(stderr, "Step2 time = %f seconds\n", (double) (tv2.tv_usec - tv1.tv_usec) / 1000000 + (double) (tv2.tv_sec - tv1.tv_sec));
	}

	if (!no_second) {
		gettimeofday(&tv1, NULL);//time of step3
		...
		gettimeofday(&tv2, NULL);
		fprintf(stderr, "Step3 time = %f seconds\n", (double) (tv2.tv_usec - tv1.tv_usec) / 1000000 + (double) (tv2.tv_sec - tv1.tv_sec));
	}
	...
	if (strcmp(outfmt, "bed") == 0) {
		...
		gettimeofday(&tv1, NULL);//time of step4
